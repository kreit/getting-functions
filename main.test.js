...
let c = 0;
let name = "Kayla";
let lastName = "Reitenbaugh";
let trafficLight = "red";

// first i declare a function with the keyword function
// then i name my function followed by parenthesis
// then i open my code block {} and write my designated code
function addition(){
c = a + b
}
